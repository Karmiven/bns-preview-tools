...
namespace Xylia.Preview.GameUI.Scene.Game_ToolTip.ItemTooltipPanel.Cell
{
	...
	public partial class ProcessComparisonCell : UserControl
	{
		...
		private static ItemIconCell LoadNormalItem(string ItemAlias, short StackCount) => GetCell(FileCache.Data.Item[ItemAlias], StackCount);


		private static ItemIconCell GetCell(BaseRecord Obj, short StackCount)
		{
